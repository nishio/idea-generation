...
parser = argparse.ArgumentParser(description='Convert PDF to PNG/text.')
parser.add_argument(
    '--indir', action='store', default='in',
    help='directory for PDFs')
parser.add_argument(
    '--outdir', action='store', default='out',
    help='directory to output PNGs')
parser.add_argument(
    '--resolution', action='store', default=200,
